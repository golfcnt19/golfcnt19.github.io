  ...
  th: {
    ...
    skills: {
      ...
      groups: [
        ...
        { group: "DevSecOps", note: "คอนเทนเนอร์ CI และงานอัตโนมัติ — พื้นฐาน ใช้ประกอบงานพัฒนา",
          items: ["Podman", "Minikube", "Kubernetes", "Jenkins", "CI/CD", "n8n", "Dynatrace", "AWS CloudShell"] },
  ...
  en: {
    ...
    skills: {
      ...
      groups: [
        ...
        { group: "DevSecOps", note: "Containers, CI and automation — working familiarity alongside dev work",
          items: ["Podman", "Minikube", "Kubernetes", "Jenkins", "CI/CD", "n8n", "Dynatrace", "AWS CloudShell"] },
