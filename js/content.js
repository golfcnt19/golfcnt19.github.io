  ...
  th: {
    ...
    skills: {
      ...
      groups: [
        ...
        { group: "DevSecOps", note: "คอนเทนเนอร์และ CI — พื้นฐาน ใช้ประกอบงานพัฒนา",
          items: ["Podman", "Minikube", "Kubernetes", "Jenkins", "CI/CD", "Dynatrace", "AWS CloudShell"] },
  ...
  en: {
    ...
    skills: {
      ...
      groups: [
        ...
        { group: "DevSecOps", note: "Containers and CI — working familiarity alongside dev work",
          items: ["Podman", "Minikube", "Kubernetes", "Jenkins", "CI/CD", "Dynatrace", "AWS CloudShell"] },
